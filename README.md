...
It's also important to note that this profit represents an operational hedge rather than pure speculation. When FTR spreads are favorable (GRE.AZ prices higher than WAUE), GRE is also paying elevated prices to serve load in its territory. The FTR effectively offsets these higher energy costs. This stabilizes GRE's overall financial position.
